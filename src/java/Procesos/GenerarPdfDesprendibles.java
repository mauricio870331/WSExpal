 ...
 */
public class GenerarPdfDesprendibles {
    ...
    public String pdf() throws SQLException, JRException {
        ...
        if (sdfc.format(date).equals("7") || sdfc.format(date).equals("8") || sdfc.format(date).equals("9")) {
            listCorreos.clear();
            ...
            try {
                ...
                String consulta = "select top 10 u.documento, u.correo, u.periodo "
                        + "from usersToConsultas u "
                        + "where recibirCorreos = 'S' and enviado = 'N' and periodo = " + Integer.parseInt(sdf.format(date)) + " "
                        + "and (select count(documento) from tbl_consultasEmpleados where documento = u.documento and aniomes = " + Integer.parseInt(sdf.format(date)) + ") > 0 ";
                ...
                while (rs.next()) {
                    ...
                    String rutaDoc = "Z:/" + doc + ".pdf";
                    listCorreos.add(doc + "," + correo + "," + rutaDoc);
